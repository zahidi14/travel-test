            ...
            <div className="filter-main">
                <div className="info">
                    ...
                    <div className="info-description">
                        <p>
                            <strong>Catatan:</strong>Kendaraan pada gambar hanya contoh.
                        </p>
                    </div>
                </div>
                <div className="filter-results">
                    ...
                    <div className="price-range range">
                        <p className="subTitle">Rentang Harga</p>
                        <div>
                            <InputRange
                                maxValue={1300}
                                minValue={50}
                    ...
                    <div className="manufacturers">
                        <p className="subTitle">Manufavture</p>
                        <div>
                        {
                    ...
                    <div className="noPassengers range">
                        <p className="subTitle">Kapasitas Penumpang</p>
                        <div>
                            <InputRange
                                maxValue={10}
                                minValue={1}
                    ...
                    <div className="vehicle-type">
                        <p className="subTitle">Tipe kendaraan</p>
                        <div>
                        {
